    ...
    async modifyItem(req, res) {
        try {
            ...
            const doc = await SupplierModel.findOneAndUpdate(
                ...
                {
                    $set: {
                        "catalog.$.name": updatedItem.name,
                        "catalog.$.description": updatedItem.description,
                        "catalog.$.price": updatedItem.price,
                        "catalog.$.tags": updatedItem.tags,
                        "catalog.$.size": updatedItem.size,
                    },
                },
                { returnOriginal: false }
            );
